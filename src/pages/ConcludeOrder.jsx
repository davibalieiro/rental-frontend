    ...
    try {
      ...
      if (coupon && coupon.id) {
        ...
        if (!couponResponse.ok) {
          ...
          console.warn(
            "Pedido criado, mas houve um erro ao usar o cupom:",
            errorData.message
          );
        }
      }
    ...
    <div className="conclude-order-container">
      ...
      <form onSubmit={handleReviewOrder} className="order-form">
        <div className="order-summary">
          ...
          <p>
            <strong>Cliente:</strong> {user?.name || "Não identificado"}
          </p>
          <p>
          ...
          <hr />
          <p>
            <strong>Cupom Aplicado:</strong> {coupon?.code || "Nenhum"}
          </p>
          <p>
